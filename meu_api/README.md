...
O objetivo aqui é o cliente poder adicionar, remover, buscar, editar "planos" no seu **Plano de Controle Financeiro**.
...
```
$ docker build -t meu-api .
```

Uma vez criada a imagem, para executar o container basta executar, **como administrador**, seguinte o comando:

```
$ docker run -p 5001:5001 meu-api
```
